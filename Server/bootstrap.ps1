#######################################################################
# Windows Update Management Solution
# 2016.11.27  Marcel de Haas
#======================================================================
# CHANGELOG
#----------------------------------------------------------------------
# 2016.11.27 | MdH  | Initial release
#######################################################################
...
Clear-Host
Write-Output "======================================================================="
Write-Output "Windows Update Management Solution                       Marcel de Haas"
Write-Output "======================================================================="
...
If ($IsElevated) {
  ...
  (new-object Net.WebClient).DownloadString(("https://" + $CurrentServer + "/bootstrap.ps1")) | Out-File "$ScriptPath\bootstrap.ps1"
	...
	#Retrieve script
  [xml]$ScriptXML = (new-object Net.WebClient).DownloadString(("https://" + $CurrentServer + "/script.xml"))
